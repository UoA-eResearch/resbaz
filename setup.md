...
- [Introduction to HPC Carpentry](#introduction-to-hpc-carpentry)
...
##### <b>Introduction to HPC Carpentry</b>

Registered attendees will recieve set up instructions via email.

##### <b>Reproducible Data Workflows with Snakemake</b>

Please see [here](https://jloveuoa.github.io/RezBaz2026_snakemake_workshop/workshop_material/02_setup.html) for set up instructions.

##### <b>Investigating Organic and Inorganic Chemistry Mechanisms Computationally using ORCA</b>

Please see the 'Programs to install' and 'ORCA templates' section [here](https://geoffreyweal.github.io/ORCA_Mechanism_Procedure) prior to the workshop.